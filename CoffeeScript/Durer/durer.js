...
(function() {
  var FillShape, GlyphFunctions, OutlineDrawer, Point, SvgPathGenerator, Util, changeProofSize, changeProportions, changeSampleText, drawProofs, drawSampleText, getLetterShape, intersect, intersectCircles, midPoint, onEvent, onload, partWay, proportions, redrawProofs, showProofsChanged, showSampleChanged, sys, vertCircle;
  ...
  proportions = {
    ...
    readFromDocument: function() {
      this.broad_stem = parseFloat((document.getElementById('broadProp')).value);
      this.narrow_stem = parseFloat((document.getElementById('narrowProp')).value);
      this.serif = parseFloat((document.getElementById('serifProp')).value);
    }
  };
