...
(function() {
  ...
  GlyphFunctions = {
    initializeCanvas: function(id) {
      ...
      this.ctx.clearRect(0, 0, sys.width, sys.height);
    ...
    initializeGlyph: function(id, proportions) {
      ...
      this.labels = {};
      prop = this.initializeSquare(this.labels, proportions.aspect);
    ...
    drawA: function(id, variant, proportions) {
      ...
      outline = new OutlineDrawer(this.ctx);
  ...
  getLetterShape = function(letter, proportions) {
    ...
    if (f !== void 0) {
      ...
      return [ctx.path, ctx.lx, ctx.rx, ctx.leftLimits, ctx.rightLimits];
    } else {
      return '';
    }
  };
